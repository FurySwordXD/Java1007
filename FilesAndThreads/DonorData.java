...
public class DonorData
{
    ...
    public static void main(String args[])
    {
        ...
        for(Donor donor : d.donors)
        {
            long totalDays = ChronoUnit.DAYS.between(donor.lastDonatedDate, currentDate);
            if (totalDays > 60)
                System.out.println(donor.name + " hasn't donated in " + totalDays + " days");
        }
